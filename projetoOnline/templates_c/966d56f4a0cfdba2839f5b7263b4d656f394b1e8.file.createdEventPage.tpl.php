<?php /* Smarty version Smarty-3.1.15, created on 2016-06-07 13:44:45
         compiled from "/usr/users2/mieic2013/up201303832/public_html/projetoOnline/templates/users/createdEventPage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19599091305756b3adb66f24-03778097%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '966d56f4a0cfdba2839f5b7263b4d656f394b1e8' => 
    array (
      0 => '/usr/users2/mieic2013/up201303832/public_html/projetoOnline/templates/users/createdEventPage.tpl',
      1 => 1465291070,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19599091305756b3adb66f24-03778097',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5756b3adc4a6a7_99566650',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5756b3adc4a6a7_99566650')) {function content_5756b3adc4a6a7_99566650($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4 profile-information-space">
          ...
          <div class="row">
            <div class="col-lg-12 profile-information panel panel-default">
              ...
              <p><i class="fa fa-user fa-lg"> You are the event creator </i></p>
            </div>
          </div>
        </div>
...
"> <?php echo $_smarty_tpl->tpl_vars['award']->value['username'];?>
				...
				<?php } ?>
				<form method="POST" class="newAward" action="#" role="form">
				<div class="create">
				  <label> Create New Award: </label>
				  <input type="hidden" name="eventid" required value=<?php echo $_smarty_tpl->tpl_vars['eventID']->value;?>
>
                  <input type="text" name="description" required class="form-control" placeholder="New Award Description">
				  <select name="username">
				  <option selected disabled>Choose Winner</option>
...
?>
					<option value=<?php echo $_smarty_tpl->tpl_vars['member']->value['username'];?>
> <?php echo $_smarty_tpl->tpl_vars['member']->value['username'];?>
 </option>
				  <?php } ?>
				  </select>
				<button type="submit" id="newAwardBtn" class="btn btn-info"> Create </button>
                </div>
              </form>
              </div>
            </div>
	...
	<script src="../javascript/createAward.js"</script>
