...
<html lang="en">
  <head>
    ...
    <title> {$eventInfo.name} - Create Award </title>
    ...
    <div class ="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 vcenter">
          <div class="grey-box"><img src="../images/award.png" alt="Award"></div>
		</div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 vcenter">
          <div class="form">
            <form method="post" action="checkAwardCreation.php" class="groupCreation-form">
