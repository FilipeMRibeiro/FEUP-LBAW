        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4 profile-information-space">
          ...
          <div class="row">
            <div class="col-lg-12 profile-information panel panel-default">
              <p><span class="group-name"> {$groupInfo.name} </span> </p>
              <p><i class="fa fa-paw fa-lg"> {$groupInfo.description} </i></p>
              <p><i class="fa fa-user fa-lg"> Creator: <a href="../pages/showProfilePage.php?username={$groupInfo.username}"> {$groupInfo.username} </a></i></p>
              <form method="POST" class="joinGroup" action="#" role="form">
                <div class="col-lg-10 join">
				  <input type="hidden" name="communityid" required value={$groupID}>
